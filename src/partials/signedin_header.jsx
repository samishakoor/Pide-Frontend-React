...
function Signedin_Header() {
  ...
  const username = 'Shaheer'; // Hardcoded username
  ...
  const signoutButton = (
    <button className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3" type="button" onClick={handleSignout}>
      Sign Out
    </button>
  );
